...
<script src="<c:url value="/resources/js/Qualification.js"></c:url>"></script>
</head> 
<body class="cbp-spmenu-push">
   <%@include file="../common/headersandMenu.jsp" %>
<div id="page-wrapper">
 <div class="container">
         <a id="add" role="button" class="btn btn-large btn-primary" data-toggle="modal">Add Qualification</a>
         <div class="row">
           <div id="myModal" class="modal fade">
               <div class="modal-dialog">
                <div class="modal-content">
                   ...
                   <h3 class="title1"><center>Qualification-Form</center></h3>
                   </div>
                    <div class="modal-body">
                    <form class="form-horizontal">
                        <div class="form-group">
                            <div class="col-md-6"><small><label class="text-primary" >Qualification ID:</label></small></div>
                            <div class="col-md-6"><small><label class="text-primary">Qualification Name:</label></small></div>
                           <div class="col-md-6 img-rounded"><input type="text" class="form-control" id="qi" placeholder="QUALIFICATION ID"></div>
                           <div class="col-md-6 img-rounded"><input type="text" class="form-control" id="qn" placeholder="QUALIFICATION NAME"></div>
                        </div>
                    </form>
                   </div>
