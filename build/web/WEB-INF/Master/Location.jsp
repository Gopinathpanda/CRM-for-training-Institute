...
<script src="<c:url value="/resources/js/Location.js"></c:url>"></script> 
</head> 
<body class="cbp-spmenu-push">
  <%@include file="../common/headersandMenu.jsp" %>
<div id="page-wrapper">
    <div class="container">
         <a id="add" role="button" class="btn btn-large btn-primary" data-toggle="modal">Add Location</a>
         <div class="row">
           <div id="myModal" class="modal fade">
               <div class="modal-dialog">
                <div class="modal-content">
                   ...
                   <h3 class="title1"><center>Location-Form</center></h3>
                   </div>
                    <div class="modal-body">
                    <form class="form-horizontal">
                        <div class="form-group">
                            <div class="col-md-4"><small><label class="text-primary" >Location ID:</label></small></div>
                           ...
                           <div class="col-md-4 img-rounded"><input type="text" class="form-control" id="lid" placeholder="LOCATION ID"></div>
                           <div class="col-md-4 img-rounded"><input type="text" class="form-control" id="ln"  placeholder="LOCATION NAME"></div>
